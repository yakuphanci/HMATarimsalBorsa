...
namespace HMATarimsalBorsa
{
    public static class BakiyeIslemStatics
    {
        ...
        public static class stdAciklama 
        {
            ...
            public static string Komisyon { get { return "İşlem Komisyonu"; } }
        };
    ...
    public class BakiyeIslemObject
    {
        ...
        public bool IslemiIsle(bool izin)
        {
            ...
            var kullanici = Veriler.GetKullanici(this.kullaniciAdi, kullanicilar);
            ...
            if (izin == true)
            {
                ...
                double degisiklikMiktariTRY = (this.degisiklikMiktari * DovizKurlari.GetDovizObject(dovizKuru).SatisFiyati());
                double olasiDurum = kullanici.Bakiye + degisiklikMiktariTRY;
                if (olasiDurum >= 0)
                {
                    //bakiye değişikliği gerçekleşti.
                    kullanici.Bakiye += degisiklikMiktariTRY;
