...
namespace HMATarimsalBorsa
{
    ...
    public static class Veriler
    {
        ...
        public static Kasa GetKasa()
        {
            ...
            var json_kasa = JsonController.GetJsonFromFile(Veriler.stdVeriYollari.path_Kasa);
            var kasa = JsonController.GetDataFromJSON<Kasa>(json_kasa);
            return kasa;
        }
        ...
        public static Kullanici GetKullanici(string kullaniciAdi, List<Kullanici>  kullanicilar)
        {
            try
            {
