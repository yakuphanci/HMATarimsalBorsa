...
namespace HMATarimsalBorsa
{
    public partial class Form_AdminPanel : Form
    {
        ...
        Panel Get_PazarNesnesi(SatilanUrun pazar, object Tag, Color BGColor)
        {
            ...
            Bitmap urunResmi = global::HMATarimsalBorsa.Properties.Resources.patates1;
            ...
            pazarNesnesi.Controls.Add(GorselNesneOlustur.Pazar.UrunFiyat_Value(fiyat, "TRY"));
        ...
        Panel Get_BekleyenBakiyeIslemNesnesi(BakiyeIslemObject islemNesnesi, object Tag)
        {
            ...
            string dovizKuru = islemNesnesi.dovizKuru;
            ...
            islemContainer.Controls.Add(GorselNesneOlustur.BakiyeIslem.IslemMiktari(miktar.ToString(), dovizKuru, FRColor));
